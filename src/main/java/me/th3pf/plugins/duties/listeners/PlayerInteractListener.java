...
public class PlayerInteractListener implements Listener
{
    ...
    public void onPlayerInteract(final PlayerInteractEvent event) {
        ...
        if (event.getPlayer().hasPermission("duties.bypass.chestinteracts") || (Duties.Config.GetBoolean("Vault.Permissions") && Duties.VaultAdapter.permission.has(event.getPlayer(), "duties.bypass.chestinteracts"))) {
            return;
        }
